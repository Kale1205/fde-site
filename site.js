...
function openDemo(){const isJa=location.pathname.includes('/ja/');const href=isJa?'../demo.html':'demo.html';const w=window.open(href,'KalesFDE_IMS_Demo');if(w)w.focus();else location.href=href}
