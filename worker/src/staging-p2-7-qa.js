...
async function createQaOrder(env, raw, now) {
  ...
  if (!['fde-ims-license', 'fde-ims-updates'].includes(productKey)) throw new P27Error('P2_7_PRODUCT_NOT_ALLOWED');
