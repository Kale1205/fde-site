...
function adminKey(){return window.FDE_ADMIN_KEY?.get?.()||$('#ordersAdminKey')?.value.trim()||$('#faqAdminKey')?.value.trim()||$('#fulfillmentKey')?.value.trim()||''}
