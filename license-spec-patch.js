...
function installLangGuard(){const html=document.documentElement;if(html.__fdeLangGuard)return;html.__fdeLangGuard=true;let current=html.getAttribute('lang')||'en';Object.defineProperty(html,'lang',{configurable:true,get(){return current},set(v){v=String(v||'en');if(v===current)return;current=v;html.setAttribute('lang',v)}})}
